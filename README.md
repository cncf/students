...
2. Get introduced to the technical concepts behind cloud native through free training courses
3. Attend the world’s largest open source conference, KubeCon + CloudNativeCon
4. Create a local community
5. Dive deeper into technical concepts to prepare for certification exams
6. Apply for paid open source mentorship programs
7. Get certified for cloud native technologies
...
## 5. **[In depth training courses](https://training.linuxfoundation.org/)**
